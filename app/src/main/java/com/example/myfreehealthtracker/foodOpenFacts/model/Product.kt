...
data class Product(
    ...
    @SerialName("product_name_bg")
    val productName_bg: String? = null,
    @SerialName("product_name_en")
    val productName_en: String? = null,
    @SerialName("product_name_es")
    val productName_es: String? = null,
    @SerialName("product_name_fr")
    val productName_fr: String? = null,
    @SerialName("product_name_pt")
    val productName_pt: String? = null,
    @SerialName("product_name_uk")
    val productName_uk: String? = null,
